export const NewsBreak = [
  {
    ...
    delay: 0.3,
    titleBreaking: 'Amazing Image Post'
  }, {
    id: 2,
    image: require('../../assets/images/img-1.jpg'),
    delay: 0.6,
...
export const CompanyProgresss = [
  {
    id: 'nav-history',
    labelLedby: 'nav-history-tab',
